...
# 2019/3/22 出力形式を一部変更　suffix 5へ変更
# 2019/4/11 引数にf_minを追加　 出力形式を一部変更　suffix 6へ変更
...
class Class_get_fp(object):
	def __init__(self,NFRAME=640, NSHIFT=320, lpcOrder=32, Delta_Freq=5, max_num_formants=5, f_min=200, suffix=6):
